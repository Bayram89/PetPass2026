...
async function ensureDemoDataset(demoAdminUser) {
  await dbClient.transaction(async (trx) => {
    ...
    const vaccinationSeeds = [
      ...
      { pet_name: "Test pet", vaccine_name: "Rabies", date_administered: "2026-06-10", next_due: "2027-06-10", veterinarian: "Harbor Cat Clinic", notes: "Post-adoption primary rabies dose." },
      { pet_name: "Test pet", vaccine_name: "FVRCP", date_administered: "2026-06-10", next_due: "2027-06-10", veterinarian: "Harbor Cat Clinic", notes: "Core feline combination vaccine." },
      { pet_name: "Test pet", vaccine_name: "Feline leukemia (FeLV)", date_administered: "2026-06-24", next_due: "2027-06-24", veterinarian: "Harbor Cat Clinic", notes: "Recommended for a young social cat with shared indoor spaces." },
      { pet_name: "Test pet", vaccine_name: "Chlamydia felis", date_administered: "2026-06-24", next_due: "2027-06-24", veterinarian: "Harbor Cat Clinic", notes: "Added after exposure-risk review for a multi-cat indoor environment." },
